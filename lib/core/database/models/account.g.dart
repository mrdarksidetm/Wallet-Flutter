...
void _accountSerialize(
  ...
  writer.writeDateTime(offsets[15], object.validThru);
}
...
Account _accountDeserialize(
  ...
  object.validThru = reader.readDateTime(offsets[15]);
  return object;
}
...
extension AccountQueryWhere on QueryBuilder<Account, Account, QWhereClause> {
  ...
  QueryBuilder<Account, Account, QAfterWhereClause> typeEqualTo(
      AccountType type) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'type',
  ...
  QueryBuilder<Account, Account, QAfterWhereClause> typeNotEqualTo(
      AccountType type) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
